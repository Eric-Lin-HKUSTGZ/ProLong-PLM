...
def main():
    ...
    # ensure the model file exist
    # local_model_dir = "/data/user/qxiao183/lwq_llm/ProLong-main/Meta-Llama-3-8B-Instruct"  # replace with model file path
    local_model_dir = "/data/user/qxiao183/lwq_llm/ProLong-main/PLM-1.8B-Base"
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        ...
        trust_remote_code=True # setting for plm training
    )
    ...
    # setting for plm training
    model = AutoModelForCausalLM.from_pretrained(local_model_dir, torch_dtype=torch.bfloat16, trust_remote_code=True, attn_implementation="flash_attention_2")
