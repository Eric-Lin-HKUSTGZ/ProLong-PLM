...
#SBATCH --mem=400G
#SBATCH --partition=plmv_lei_rent
...
model=${MODEL:-/data/user/qxiao183/lwq_llm/ProLong-main/PLM-1.8B-Base}
# Point to the base dir of the ProLong 64K data
dataset=${DATASET:-"datasets/plm-long-context-65536"}
...
# 第三步：设置其他环境变量 ----------------------------
export LOGIT_BLOCK_SIZE=2048  # Reduced from 2048 to save memory
export WANDB_PROJECT="plm"
...
base_arguments=(
    ...
    --dataloader_num_workers 1  # Reduce to 0 to save memory
